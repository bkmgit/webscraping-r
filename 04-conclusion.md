...
Now that we have seen one way to scrape data from websites and are
...
The good news is that a good web scraper, such as rvest, recognizes that this is a risk and includes
...
This is rvest's default behaviour, and it should prevent most scraping projects from ever causing problems.
...
* [This blog](https://blog.rubyroidlabs.com/2016/04/web-scraping-1/) has a discussion on
  some of the legal aspects of web scraping.
